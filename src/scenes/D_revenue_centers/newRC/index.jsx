...
async function addRC(rc, name, items) {
    ...
    try {
        await setDoc(doc(db, "Registers", rc + "1"), {
            name: name,
            revenueCenter: rc,
            registerNumber: 1,
            revenue: 0,
...
async function updateArr(newItems, rc){
...
export default function CreateNewRc() {
    ...
    const handleChangeRCName = (event) => {
    ...
    useEffect(() => {
        ...
        getItemListLeft().then(r => console.log("Got Rows"));
    }, []);
                ...
                >
                    ...
                    <DialogContent>
                        ...
                        <Button
                            ...
                            sx={{marginTop: 2}}
                            onClick={ () => {
                                addRC(rc, standName, selected).then(r => "Added new Rc");
